    ...
    def run(self):
        ...
        while True:
            if keyboard.is_pressed('ctrl+c'):
                windowloc = "+" + str(ROOT.winfo_pointerx()) + "+" + str(ROOT.winfo_pointery())
                ROOT.geometry(windowloc)
                ...
                if price != 0.0:
                    ...
                    LABEL.config(text=f'{itemname}: {prettyprice[0:4]}c')
            else:
